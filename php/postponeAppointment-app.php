...
try{
	...
	postponeAppointmentDetails($user_id,$shop_id,$appointment_id);
...
function postponeAppointmentDetails($user_id,$shop_id,$appointment_id){
	try{
		...
		$sql="update Client_Shop_Apnt a set a.user_apnt_status = 'POSTPONED'
...
function insertNotification($user_id,$shop_id,$appointment_id){
	try{
		...
		$sql="insert into Notification(Appointment_ID,User_ID,Shop_ID,User_Notification) values ($appointment_id,$user_id,$shop_id,'POSTPONED');";
...
function updateNotification($user_id,$shop_id,$appointment_id){
	try{
		...
		$sql="update Notification set User_Notification='POSTPONED' where Appointment_ID=$appointment_id and User_ID=$user_id and Shop_ID=$shop_id;";
